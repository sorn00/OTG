      ...
      <div className="grid gap-6 md:grid-cols-4">
        ...
        <div>
          ...
          <div className="mt-2 flex gap-3 text-white/70">
            <a href="https://facebook.com" aria-label="Facebook" className="underline-offset-4 hover:underline">Facebook</a>
            <a href="https://instagram.com" aria-label="Instagram" className="underline-offset-4 hover:underline">Instagram</a>
            <a href="https://youtube.com" aria-label="YouTube" className="underline-offset-4 hover:underline">YouTube</a>
          </div>
        </div>
      </div>
